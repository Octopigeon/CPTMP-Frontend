...
describe('CustomIconRegistry', () => {
  it('should get the SVG element for a preloaded icon from the cache', () => {
    ...
    const mockErrorHandler: ErrorHandler = {handleError(error: any) {}};
    ...
    const registry = new CustomIconRegistry(mockHttp, mockSanitizer, mockDocument, mockErrorHandler, svgIcons);
